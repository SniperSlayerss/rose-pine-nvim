...
local function set_highlights()
	...
	local default_highlights = {
		...
		DiagnosticVirtualTextError = { fg = groups.error, bg = "#3b1f27" },
		DiagnosticVirtualTextHint = { fg = groups.hint, bg = "#332b3d" },
		...
		DiagnosticVirtualTextWarn = { fg = groups.warn, bg = "#3d3428" },
